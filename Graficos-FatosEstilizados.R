...
rects <- data.frame(xstart = c(1999,2003,2010,2014,2016), 
                    xend = c(2003,2010,2014,2016,2019), 
                    col = c('I (99-03)','II (04-10)','III (11-14)','IV (15-16)','V (17-19)'))
...
metasplot <- ggplot(df)  + 
  ...
  scale_x_continuous(breaks=seq(1999,2019,1),                       
                     labels=paste(c(""),rep(1999:2019,each=1)),expand = c(0.012, 0.02)) +
